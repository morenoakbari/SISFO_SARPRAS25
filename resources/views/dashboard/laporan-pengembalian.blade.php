...
<body class="min-h-screen flex text-gray-800">
    ...
    <main class="flex-1 p-6 md:p-10 max-w-7xl mx-auto">
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
            <div>
                <h1 class="text-2xl md:text-3xl font-bold text-gray-900">Laporan Pengembalian</h1>
                <p class="text-gray-500 mt-1">Data semua pengembalian barang</p>
            </div>
        </div>
        ...
        <a href="{{ route('laporan.pengembalian.export') }}"
            class="bg-red-900 hover:bg-red-700 text-white px-4 py-2 rounded text-sm font-semibold shadow inline-block mb-4">
