...
<body class="min-h-screen bg-white-100 text-slate-800 flex">
    ...
    <main class="flex-1 p-6 md:p-10">
        <!-- Welcome Section -->
        <section class="mb-8">
            <h1 class="text-3xl md:text-4xl font-bold text-red-800">Selamat Datang, {{ Auth::user()->name }} !</h1>
        ...
        <section class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
            ...
            <div class="relative bg-white border border-red-100 rounded-2xl shadow-md hover:shadow-xl transition p-6 flex flex-col gap-2 overflow-hidden">
                ...
                <div class="text-4xl font-bold text-red-900">{{ $users->count() }}</div>
                <div class="text-lg font-medium text-red-600">Users</div>
            </div>
            ...
            <div class="relative bg-white border border-red-100 rounded-2xl shadow-md hover:shadow-xl transition p-6 flex flex-col gap-2 overflow-hidden">
                ...
                <div class="text-4xl font-bold text-red-900">{{ $kategoris->count() }}</div>
                <div class="text-lg font-medium text-red-600">Kategori</div>
            </div>
            ...
            <div class="relative bg-white border border-red-100 rounded-2xl shadow-md hover:shadow-xl transition p-6 flex flex-col gap-2 overflow-hidden">
                ...
                <div class="text-4xl font-bold text-red-900">{{ $barangs->count() }}</div>
        ...
        <!-- Statistik Section -->
        <section class="mb-8">
            <h2 class="text-2xl font-semibold mb-2 text-red-700">Statistik</h2>
            <p class="text-slate-600 mb-4">Berikut adalah statistik pengguna dan barang.</p>
        </section>

        <!-- Placeholder Content -->
        <section class="bg-white border border-red-100 rounded-xl shadow p-6">
            <h2 class="text-xl font-semibold mb-2 text-red-700">Infooo</h2>
